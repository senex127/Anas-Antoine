      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
		  ...
		  <li class="nav-item">
            ...
            <a class="nav-link" aria-current="page"  href="Catalogue.php">Fruits/Legumes</a>
...
$vegetaux = $stmt->fetchAll(PDO::FETCH_ASSOC);

?>	

	<div class="row">

		<?php foreach($vegetaux as $v) : ?>

				<div class="card" >

				  <img class="card-img-top" src="images/<?= $v['prod_image'] ?>" alt="Card image cap">

				  <div class="card-body">

					<h5 class="card-title"><?= $v['prod_nom'] ?></h5>

					<p class="card-text"></p><?= $v['prod_description'] ?>

					<p class="card-text"></p><?= '€ '.$v['prod_prix'].' KG' ?>
