...
require_once("../controlleurs/Panier_commande.php");
...
<a id="btnEmpty" href="Commande.php?action=empty">Empty Cart</a>
...
<?php		
    ...
    foreach ($_SESSION["cart_item"] as $item){
        ...
        $item_price = $item["quantity"]*$item["prod_prix"];

		?>

				<tr>

				<td><?php echo $item["prod_nom"]; ?></td>

				<td><?php echo $item["prod_description"]; ?></td>

				<td style="text-align:right;"><?php echo $item["quantity"]." Kg"; ?></td>

				<td  style="text-align:right;"><?php echo "€ ".$item["prod_prix"]; ?></td>

				<td  style="text-align:right;"><?php echo "€ ". number_format($item_price,2); ?></td>

				<td style="text-align:center;"><a href="Commande.php?action=remove&code=<?php echo $item["prod_description"]; ?>" class="btnRemoveAction"><img src="icon-delete.png" alt="Remove Item" /></a></td>
				...
				$total_price += ($item["prod_prix"]*$item["quantity"]);
...
require_once("../vues/Commande.php");
...
VALUES ( 'blablabla','non livreé', now(), '$total_price', '$id_user', 1);";
...
<div id="product-grid">
	...
	$product_array = $db_handle->runQuery("SELECT * FROM Produit");
	...
	?>
		...
		<form method="post" action="Commande.php?action=add&code=<?php echo $product_array[$key]["prod_description"]; ?>">

			<div class="images"><img src="images/<?= $product_array[$key]["prod_image"] ?>"></div>

			<div class="product-tile-footer">

			<div class="product-title"><?php echo $product_array[$key]["prod_nom"]; ?></div>

			<div class="product-price"><?php echo "€".$product_array[$key]["prod_prix"]." Kg"; ?></div>
