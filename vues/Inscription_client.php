<html>
    ...
    <body>
        ...
        <form method="POST" action="../controlleurs/Verif_InscriptionClient.php">
            ...
            <label for="inputPassword" class="sr-only">Numéro téléphone</label>

            <div class="tel">

                <input type="text" name="Tel" id="inputPassword" class="form-control" placeholder="Télephone" required>
            ...
            <div class="adresse">
                ...
                <input type="text" name="Adresse" id="inputPassword" class="form-control" placeholder="Adresse" required>
