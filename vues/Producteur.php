  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <form method="POST" action="../controlleurs/Connexion_producteur.php">
            
            <h1 class="h3"> Producteur: Enregistrez vous</h1>
			<div class="error">
            ...
            <div class="btnCo">
                <button class="btn btn-lg btn-primary btn-block" type="submit" name="formlogin">Connexion</button>
            </div>

        </form>

        <form method="POST" action="Inscription_producteur.php">
